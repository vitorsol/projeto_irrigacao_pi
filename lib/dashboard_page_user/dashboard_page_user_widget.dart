...
import 'dashboard_page_user_model.dart';
export 'dashboard_page_user_model.dart';

class DashboardPageUserWidget extends StatefulWidget {
  const DashboardPageUserWidget({super.key});

  @override
  State<DashboardPageUserWidget> createState() =>
      _DashboardPageUserWidgetState();
}

class _DashboardPageUserWidgetState extends State<DashboardPageUserWidget>
    with TickerProviderStateMixin {
  late DashboardPageUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardPageUserModel());
